...
import { ProjectUpdateCascadeInterceptor } from 'src/interceptors/project-update-cascade/project-update-cascade.interceptor';
...
export class TasksController {
  ...
  @UseInterceptors(ProjectUpdateCascadeInterceptor)
